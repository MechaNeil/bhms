...
//         document.getElementById('profilePictureFeedback').style.display = 'block';
//     } else {
//         this.classList.remove('is-invalid');
//         document.getElementById('profilePictureFeedback').style.display = 'none';
//     }
// });

// document.getElementById('proofOfIdentity').addEventListener('change', function () {
//     const allowedTypes = ['image/jpeg', 'image/png', 'application/pdf'];
//     const file = this.files[0];
//     if (file && !allowedTypes.includes(file.type)) {
//         this.classList.add('is-invalid');
//         document.getElementById('proofOfIdentityFeedback').style.display = 'block';
//     } else {
//         this.classList.remove('is-invalid');
//         document.getElementById('proofOfIdentityFeedback').style.display = 'none';
//     }
// });


// // Progress Bar addTenant
// document.getElementById('addTenantForm').addEventListener('input', function () {
...
//     document.getElementById('formProgress').ariaValueNow = progress;
// });

// // Progress Bar edit
// document.getElementById('editTenantForm').addEventListener('input', function () {
//     const requiredFields = document.querySelectorAll('#editTenantForm [required]');
//     const filledFields = Array.from(requiredFields).filter(field => field.value !== '');
//     const progress = (filledFields.length / requiredFields.length) * 100;
//     document.getElementById('formProgress2').style.width = progress + '%';
//     document.getElementById('formProgress2').ariaValueNow = progress;
// });
