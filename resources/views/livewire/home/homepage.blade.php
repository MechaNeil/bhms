<div>
                ...
                <div class="d-flex flex-wrap justify-content-between align-items-center">
                    <ul class="info d-flex flex-wrap list-unstyled m-0">
                        <li class="location text-capitalize d-flex align-items-center me-4" style="font-size: 14px;">
                            ...
                            </svg>Calatagan Proper, Virac, Catanduanes
                        </li>
            ...
            <div class="container-fluid padding-side">
                <div class="d-flex justify-content-between align-items-center w-100">
                    <a class="navbar-brand" href="#">
                        <img src="{{ asset('assets/img/mn2.png') }}" class="logo img-fluid" style="width: 80px">
                    </a>
                            ...
                            <ul class="navbar-nav align-items-center mb-2 mb-lg-0">
                                ...
                                <li class="nav-item px-3 dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end animate slide mt-3 border-0 shadow">
                                        <li><a href="#" class="dropdown-item ">About </a>
                                        </li>
    ...
    <section id="about-us" class="padding-large">
        <div class="container-fluid padding-side" data-aos="fade-up">
            <h3 class="display-3 text-center fw-normal col-lg-4 offset-lg-4">MN's Bhouse: Live Your Life To the Fullest
            </h3>
            <div class="row align-items-start mt-3 mt-lg-5">
                <div class="col-lg-6">
                    <div class="p-5">
                        <p>Welcome to MN's Bhouse, where comfort meets tranquility. Nestled in the heart of a bustling
                            city, our
                            BHouse offers a peaceful retreat for both business and leisure travelers. With modern
                            amenities, and a
                    ...
                    <img src="{{ asset('home/images/about-img1.jpg') }}" alt="img" class="img-fluid rounded-4 mt-4">
                </div>
                <div class="col-lg-6 mt-5 mt-lg-0">
                    <img src="{{ asset('home/images/about-img2.jpg') }}" alt="img" class="img-fluid rounded-4">
                    <img src="{{ asset('home/images/about-img3.jpg') }}" alt="img" class="img-fluid rounded-4 mt-4">
        ...
        <div class="container" data-aos="fade-up">
            <div class="row">
                <div class="col-md-3 text-center mb-4 mb-lg-0">
                    <h3 class="display-1 fw-normal text-primary position-relative">100 <span
                            class="position-absolute top-50 end-50 translate-middle z-n1 ps-lg-4 pt-lg-4"><img
                                src="{{ asset('home/images/pattern1.png') }}" alt="pattern" class="img-fluid"></span>
                    </h3>
                    <p class="text-capitalize">Happy Tenants</p>
                </div>
                <div class="col-md-3 text-center mb-4 mb-lg-0">
                    <h3 class="display-1 fw-normal text-primary position-relative">160 <span
                            class="position-absolute top-50 translate-middle z-n1"><img
                                src="{{ asset('home/images/pattern1.png') }}" alt="pattern" class="img-fluid"></span>
                    </h3>
                ...
                <div class="col-md-3 text-center mb-4 mb-lg-0">
                    ...
                    <p class="text-capitalize">apartments</p>
                </div>
                <div class="col-md-3 text-center mb-4 mb-lg-0">
                    <h3 class="display-1 fw-normal text-primary position-relative">35 <span
                            class="position-absolute top-50 end-50 pb-lg-4 pe-lg-2 translate-middle z-n1"><img
                                src="{{ asset('home/images/pattern1.png') }}" alt="pattern" class="img-fluid"></span>
                    </h3>
                    <p class="text-capitalize">avialable rooms</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
                            <img src="{{ asset('home/images/room1.jpg') }}" alt="img"
                            ...
                            <div class="product-description position-absolute p-5 text-start">
                                ...
                                <p class="product-paragraph text-white">Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit.
                                ...
                                <table>
                                    <tbody>
                                        <tr class="text-white">
                                            ...
                                            <td class="price">Php 3,000 /Monthly</td>
                                        </tr>
                                        <tr class="text-white">
                        ...
                        <div class="room-content text-center mt-3">
                            ...
                            <p><span class="text-primary fs-4">Php 5,000</span>/Monthly</p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
                            <img src="{{ asset('home/images/room3.jpg') }}" alt="img"
                                class="post-image img-fluid rounded-4">
                            <div class="product-description position-absolute p-5 text-start">
                        ...
                        <div class="room-content text-center mt-3">
                            ...
                            <p><span class="text-primary fs-4">Php 4,000</span>/Monthly</p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
                            <img src="{{ asset('home/images/room2.jpg') }}" alt="img"
                                class="post-image img-fluid rounded-4">
                            <div class="product-description position-absolute p-5 text-start">
                        ...
                        <div class="room-content text-center mt-3">
                            ...
                            <p><span class="text-primary fs-4">Php 3,000</span>/Monthly</p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
                        ...
                        <div class="room-content text-center mt-3">
                            <h4 class="display-6 fw-normal"><a href="#">Grand deluxe rooms</a></h4>
                            <p><span class="text-primary fs-4">Php 2,069</span>/Monthly</p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
                        ...
                        <div class="room-content text-center mt-3">
                            <h4 class="display-6 fw-normal"><a href="#">Sweet Family room</a></h4>
                            <p><span class="text-primary fs-4">Php 3,060</span>/Monthly</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container position-relative">
            <div class="row">
                <div class="swiper gallery-swiper offset-1 col-10">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="{{ asset('home/images/item3.jpg') }}" alt="img" class="img-fluid rounded-4">
                        </div>
                        <div class="swiper-slide">
                            <img src="{{ asset('home/images/item2.jpg') }}" alt="img" class="img-fluid rounded-4">
                        </div>
                        <div class="swiper-slide">
                            <img src="{{ asset('home/images/item1.jpg') }}" alt="img" class="img-fluid rounded-4">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="footer">
            ...
            <footer class="row">
                <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
                    ...
                    <p class="mt-3">Welcome to MN's Bhouse, where comfort meets tranquility. Nestled in the heart of a
                        bustling
                        city, our
                        BHouse offers a peaceful retreat for both.</p>
                ...
                <div class="col-md-6 col-lg-3 offset-lg-1 mb-4 mb-lg-0">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="email d-flex align-items-center mt-2">
                            <svg class="color me-1" width="20" height="20">
                                <use xlink:href="#email"></use>
                            </svg>mneil@gmail.com
                        </li>
        ...
        <div class="container-fluid padding-side padding-small" data-aos="fade-up">
            <footer class="row">
                ...
                <div class="col-md-6 col-lg-3 offset-lg-1 mb-4 mb-lg-0">
                    <p class="m-0">© Copyright 2024 MN's Bhouse. </p>
